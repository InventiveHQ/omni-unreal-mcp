 ...
 *
 * The headline lazy-loading tool — instead of hand-wrapping thousands of
 * UE APIs as individual MCP tools, expose the editor's full Python surface
 * through a single execute command. The AI gets at the `unreal` Python
 * module directly.
 *

...
**One unified Unreal Engine MCP plugin — cobbled from the best of the open-source UE MCP ecosystem.**
...
This project is forked from [`kks3800/Unreal_MCP`](https://github.com/kks3800/Unreal_MCP) (MIT), itself derived from [`chongdashu/unreal-mcp`](https://github.com/chongdashu/unreal-mcp). We're extending it with commands ported from other MIT-licensed UE MCP projects and fresh implementations against UE's documented APIs. See [NOTICE.md](NOTICE.md) for the full source map.
